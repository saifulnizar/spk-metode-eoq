...
<br>
<p class="text-center h4">TB.MORODADI &nbsp; Halaman Gudang</p>
		  ...
		  <nav aria-label="breadcrumb">
			<ol class="breadcrumb clearfix d-none d-md-inline-flex pt-0">
			 <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
			  ...
			  <li class="nav-item">
				<button class="nav-link btn-sm btn btn-indigo" id="pills-profile-tab" data-toggle="pill" href="#pills-supp" role="tab"
				  aria-controls="pills-profile" aria-selected="false">SUPPLIER</button>
			  </li>
			  <li class="nav-item">
			  ...
			  <li class="nav-item">
				<button class="nav-link btn-sm btn btn-indigo" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab"
				  aria-controls="pills-contact" aria-selected="false">DATA PEMBELIAN</button>
			  </li>
			 </ul>
			</ol>
		  </nav>
	...
	<div class="container">
		...
		<div class="tab-content  pl-1" id="pills-tabContent">
			...
			<div class="tab-pane fade" id="pills-supp" role="tabpanel" aria-labelledby="pills-home-tab">	
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
       <!-- Default form grid -->
<form action="<?php echo site_url('gudang/save_pembelian')?>" method="post">
  <!-- Grid row -->
  <div class="row">
    <div class="col-6">
	...
	<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form action="<?php echo site_url('gudang/edit_supp')?>" method="post">
			  <div class="modal-body mx-3">
		...
		<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form action="<?php echo site_url('gudang/save_supp')?>" method="post">
			  <div class="modal-body mx-3">
		...
		<div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form action="<?php echo site_url('gudang/hapus_supp')?>" method="post">
			  <div class="modal-body mx-3">
		...
		<div class="modal fade" id="Tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form action="<?php echo site_url('gudang/save_barang')?>" method="post">
			  <div class="modal-body mx-3">
		...
		<div class="modal fade" id="modalHapusBarang" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form action="<?php echo site_url('gudang/hapus_barang')?>" method="post">
			  <div class="modal-body mx-3">
		...
		<div class="modal fade" id="Edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form action="<?php echo site_url('gudang/edit_barang')?>" method="post">
			  <div class="modal-body mx-3">
		...
		<div class="modal fade" id="restok" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form action="<?php echo site_url('gudang/update_pembelian')?>" method="post">
			  <div class="modal-body mx-3">
